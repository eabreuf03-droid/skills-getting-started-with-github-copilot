document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and reset dropdown options so the UI reflects the latest data.
              ...
              .map(
                (email) => `
                  <li class="participant-item">
                    ...
                    <button type="button" class="remove-participant" data-activity="${name}" data-email="${email}" aria-label="Remove ${email} from ${name}">×</button>
                  </li>
                `
              )
              .join("")
